...
public interface UserMapper{
    ...
    @Update("update user_info set userName = #{userName}, password = #{password}, updateTime = #{updateTime} where userUuid = #{userUuid}")
    public void upadteUserInfo(@Param("userName") String userName, @Param("password") String password, @Param("updateTime") String updateTime, @Param("userUuid") String userUuid);
